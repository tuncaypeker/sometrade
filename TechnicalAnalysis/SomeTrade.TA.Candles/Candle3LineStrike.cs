...
namespace SomeTrade.Candles
{
    public class Candle3LineStrike : CandleIndicator
    {
        ...
        public CandleResult Compute(int startIdx, int endIdx)
        {
            ...
            while (i < startIdx)
            {
                _nearPeriodTotal[3] += GetCandleRange(CandleSettingType.Near, i - 3);
        ...
        public override bool GetPatternRecognition(int i)
        {
            bool is3LineStrike =
                ...
                GetCandleAverage(CandleSettingType.Near, _nearPeriodTotal[3], i - 3) &&
        ...
        {
            return GetCandleAvgPeriod(CandleSettingType.Near) + 3;
        }
    }
}
