...
namespace SomeTrade.Strategies.Interfaces
{
    public abstract class StrategyBase : IStrategy
    {
        ...
        public abstract CheckResult ShouldCloseLong();
        public abstract CheckResult ShouldCloseShort();
        public abstract TrailingStopResult UpdateTrailingStop(decimal entryPrice, int side, decimal quantity);
        public abstract bool ShouldStop(decimal entryPrice, int side);
        public abstract Dictionary<string,string> GetCalculations();
